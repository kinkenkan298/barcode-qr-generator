    ...
    <Card className="overflow-hidden border-none shadow-2xl shadow-blue-500/10 p-0">
      ...
      <div className="p-10 flex flex-col items-center text-center">
        ...
        <div className="relative group">
          <div className="absolute -inset-1 bg-linear-to-r from-blue-600 to-indigo-600 rounded-3xl blur opacity-20 group-hover:opacity-40 transition duration-1000" />
          <div
            className={`
                ...
                ${timeLeft < 10 ? "border-rose-100 shadow-rose-100" : "border-slate-50 shadow-xl shadow-slate-200/40"}
              `}
          >
          ...
          {isRefreshing && (
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
              <div className="p-3 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-full shadow-lg">
